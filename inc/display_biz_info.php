...
$content .= '<p class="site-title"><a href="' . esc_url($site_home) . '" rel="home">' . esc_html($site_title) . '</a></p>';
if ( $site_description || is_customize_preview() ) :
$content .= '<p class="site-description">' . esc_html($site_description) . '</p>';
endif;
$content .= '<!-- address -->';
...
$content .= '<p class="site-phone"><a href="tel:' . esc_html($site_phone) . '" itemprop="telephone">' . esc_html($site_phone) . '</a></p>';
endif;
if ( $site_email || is_customize_preview() ) :
$content .= '<p class="site-email"><a href="mailto:' . esc_html($site_email) . '" itemprop="email">' . esc_html($site_email) . '</a></p>';
endif;
$content .= '</div>';
